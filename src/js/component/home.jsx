...
const Home = () => {
	...
	return (
		<div className="text-center">
			<div className="caja-contador mt-5">
			...
			<div className="container text-center mt-3">
				...
				<div className="container text-center mt-3">
					<button className="mx-1 btn btn-success"> Inicio     </button>
					<button className="mx-1 btn btn-danger">  Parar      </button>
					<button className="mx-1 btn btn-warning"> Reiniciar  </button>
				</div>
			</div>
		</div>
	);
